...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Process an HTML file and output a Python file."
    )
    parser.add_argument(
        "filename",
        help="The name of the HTML file (without extension) located in the src folder.",
    )
    parser.add_argument(
        "--output-dir",
        default=".",
        help="Optional output directory for the .py file (default is root).",
    )
